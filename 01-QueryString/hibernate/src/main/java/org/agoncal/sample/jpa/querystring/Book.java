...
//        @NamedQuery(name = "findAllScifiBooks", query = "SELECT b FROM Book b WHERE 'scifi' member of b.tags  ORDER BY b.id DESC") // TODO doesn't work with Hibernate http://opensource.atlassian.com/projects/hibernate/browse/HHH-5713
